...
public class EntityArrowPort extends Entity implements IProjectile {
    ...
    public EntityArrowPort(World par1World)
    {
        super(par1World);
    ...
    public EntityArrowPort(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityArrowPort(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityArrowPort(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ACMItem.arrowPort, 1)))
            {
                flag = false;
            }
     ...
     */
    public static DamageSource causeArrowDamage(EntityArrowPort par0EntityArrow, Entity par1Entity)
    {
