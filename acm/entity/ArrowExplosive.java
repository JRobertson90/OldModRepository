...
public class ArrowExplosive extends Entity implements IProjectile {
    ...
    public ArrowExplosive(World par1World)
    {
        super(par1World);
    ...
    public ArrowExplosive(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public ArrowExplosive(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public ArrowExplosive(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    {
        super.onUpdate();
        final float explosionStrength = 1.5F;
        if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F)
        {
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, i1))
                    {
                    	...
                    	if(shootingEntity != null) {
                        	player = (EntityPlayer) shootingEntity;	
                        }
                    	this.worldObj.newExplosion(player, (float)this.posX + 0.5F, (float)this.posY + 0.5F, (float)this.posZ + 0.5F, explosionStrength, true, true);
                    	movingobjectposition.entityHit.setFire(5);
                    	this.setDead();
                    }
                    else
                ...
                else
                {
                    ...
                    this.worldObj.newExplosion(player, xTile + 0.5F, yTile + 0.5F, zTile + 0.5F, explosionStrength, true, true);
                	this.setDead();
                    if (this.inTile != 0)
                    {
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ACMItem.explosiveArrow, 1)))
            {
                flag = false;
            }
     ...
     */
    public static DamageSource causeArrowDamage(ArrowExplosive par0EntityArrow, Entity par1Entity)
    {
