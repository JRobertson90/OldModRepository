...
public class ArrowFar extends EntityArrow {
    ...
    public ArrowFar(World par1World)
    {
        super(par1World);
    ...
    public ArrowFar(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public ArrowFar(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public ArrowFar(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
	...
	public void setThrowableHeading(double par1, double par3, double par5, float par7, float par8)
    {
        ...
        par3 /= f2;
        par5 /= f2;
        //Absolutely no randomness in the shots, this arrow is consistent every time.
     ...
     */
    public static DamageSource causeArrowDamage(ArrowFar par0EntityArrow, Entity par1Entity)
    {
