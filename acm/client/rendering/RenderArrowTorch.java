...
public class RenderArrowTorch extends Render {
	
	private static final ResourceLocation arrowTextures = new ResourceLocation("acm:textures/entity/arrow_torch.png");

    public void renderArrow(EntityArrowTorch par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getArrowTextures(EntityArrowTorch par1EntityArrow)
    {
    ...
    {
        return this.getArrowTextures((EntityArrowTorch)par1Entity);
    }
    ...
    {
        this.renderArrow((EntityArrowTorch)par1Entity, par2, par4, par6, par8, par9);
    }
}