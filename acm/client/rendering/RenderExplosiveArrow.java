...
public class RenderExplosiveArrow extends Render {
	...
	private static final ResourceLocation arrowTextures = new ResourceLocation("acm:textures/entity/arrow_explosive.png");

    public void renderArrow(ArrowExplosive par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getArrowTextures(ArrowExplosive par1Entity)
    {
    ...
    {
        return this.getArrowTextures((ArrowExplosive)par1Entity);
    }
    ...
    {
        this.renderArrow((ArrowExplosive)par1Entity, par2, par4, par6, par8, par9);
    }
}