...
public class RenderArrowPort extends Render {
	
	private static final ResourceLocation arrowTextures = new ResourceLocation("acm:textures/entity/arrow_port.png");

    public void renderArrow(EntityArrowPort par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getArrowTextures(EntityArrowPort par1EntityArrow)
    {
    ...
    {
        return this.getArrowTextures((EntityArrowPort)par1Entity);
    }
    ...
    {
        this.renderArrow((EntityArrowPort)par1Entity, par2, par4, par6, par8, par9);
    }
}